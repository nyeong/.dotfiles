    ...
    (unless (file-exists-p journal-file)
      (with-temp-file journal-file
        (let* ((current-dow (string-to-number (format-time-string "%u" today))) ; 1-7, Monday is 1
          ...
          (insert (concat
                   ":PROPERTIES:\n"
                   ":CREATED: <" (substring date-str 1 -1) ">\n"
                   ":MODIFIED: <" (substring date-str 1 -1) ">\n"
                   ":END:\n"
                   "#+TITLE: " week-id "\n"
                   "#+FILETAGS: :weekly:\n"
...
[[https://github.com/remimimimimi/org-typst-preview.el][GitHub - remimimimimi/org-typst-preview.el: Preview Typst code blocks in org-...]]
