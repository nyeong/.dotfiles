...
#+RESULTS:
| doom-modeline-update-vcs | doom-modeline-update-buffer-file-name | nyeong/mark-git-changes | +evil-display-vimlike-save-message-h | doom-auto-revert-buffers-h | doom-guess-mode-h |
